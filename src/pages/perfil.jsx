    ...
    return (
        <div className="relative ">
            ...
            <div className="mt-[3%] flex flex-col  gap-3 text-center w-[201vh] px-[35%]">
                ...
                <input className="border-s-black rounded-lg text-gray-300 p-3" type="text" placeholder=" Introducir número de télefono o email" value={user} onChange={(e) => setUser (e.target.value) }/>
                
                <button onClick={registro(user)} className="bg-black rounded-lg text-white p-3  hover:bg-gray-500 transition-colors duration-300 ease-in-out">Continuar</button>
